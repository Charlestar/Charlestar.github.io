...
\label{eq:OpticalFlowCE}\tag{OpticalFlowCE}
$$
...
$$I(x+\delta x,y+\delta y,t+\delta t) = I(x,y,t)+\frac{\partial I}{\partial x}\delta x + \frac{\partial I}{\partial y}\delta y + \frac{\partial I}{\partial t}\delta t + \epsilon \label{eq:OpticalFlowTaylor}\tag{OpticalFlowTaylor}$$
...
两边同除以\(\delta t\)得到： \[ \label{eq:OpticalFlow} \frac{\partial I}{\partial x}\frac{\delta x}{\delta t} + \frac{\partial I}{\partial y}\frac{\delta y}{\delta t} + \frac{\partial I}{\partial t} = 0 \]
...
\[ \label{eq:OptivalFlowEQs} \begin{aligned}
