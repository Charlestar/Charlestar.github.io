...
$$ 
\begin{aligned} 
f_2(\symbf{x}) & = f_1(\symbf{x} - \symbf{d}) \\ 
...
c_2 & = \symbf{d}^\mathsf{T}\symbf{A}_1\symbf{d}-\symbf{b}_1^\mathsf{T}\symbf{d} + c_1 
\end{aligned} 
$$
...
$$ 
\sum_{\Delta \symbf{x}\in I} \omega(\Delta \symbf{x})
\left \| 
\symbf{A}(\symbf{x} + \Delta \symbf{x})\symbf{d}(\symbf{x}) 
- \Delta \symbf{b}(\symbf{x} + \Delta \symbf{x}) 
\right\|^{2} 
$$
...
$$ 
\symbf{d}(\symbf{x}) = 
\left(\sum \omega\symbf{A}^\mathsf{T}\symbf{A}\right)^{-1}
\sum \omega \symbf{A}^\mathsf{T}\Delta \symbf{b} 
$$
